    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr height="80" valign="top" >
        <td  height="80"><table width="100%" border="0">
            ...
            <tr>
              <td bgcolor="#e92c55" style="text-align:right;font-family:Verdana;font-size:18px;color:#fff;text-decoration:none;text-indent:10px;height: 25px;"><b><?=$project_name?> Enquiry Received</b>&nbsp;</td>
            </tr>
          </table></td>
      </tr>
      <tr>
