  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <form class="da-home-form form-horizontal"  method="post" action="<?php echo base_url(); ?>admin/blog/add_blog" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" required class="form-control" name="blog_name" id="blog_name" maxlength="150" data-msg-required="Please enter name." value="<? if(isset($_POST["blog_name"])){ echo $_POST["blog_name"]; }?>" >
              </div>
            </div>
            
            <div class="form-group">
              <label for="blog_image" class="col-sm-3 control-label"><span class="required">*</span>Image <?=NEWSEVENTIMGSIZE?></label>
              <div class="col-sm-4">
             <?php /*?> imgwidthheight="<?=NEWS_blog_WIDTH?>X<?=NEWS_blog_HEIGHT?>"<?php */?>
                <input type="file" required class="form-control"  name="blog_image"  id="blog_image" value="<? if(isset($_POST["blog_image"])){ echo $filepath; }?>" data-msg-required="Please upload image." >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <textarea  class="form-control" required name="short_description" id="short_description" rows="3" data-msg-required="Please enter short description."><? if(isset($_POST["short_description"])){ echo $_POST["short_description"];}?>
</textarea>
              </div>
            </div>
            <div class="form-group">
...
<script>
  ...
  function newsblogType() {
    var sel = document.getElementById("news_blog_type_id").selectedIndex;
