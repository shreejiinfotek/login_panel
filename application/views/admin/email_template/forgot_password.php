    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr height="80" valign="top" >
        <td height="80"><table width="100%" border="0">
            ...
            <tr>
              <td bgcolor="#e92c55" style="text-align:right;font-family:Verdana;font-size:18px;color:#fff;text-decoration:none;text-indent:10px;height: 25px;"><b><?=$project_name?> Forgot Password</b>&nbsp;</td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td style="padding:20px;"><table>
            ...
            <tr> <td><p>We received a request to reset the password associated with this e-mail address. If you made this request, please follow the instructions below.</p>
                      <p>Click on the link below to reset your password using our server: <a href="<?=$site_url?>admin/reset_password/index/<?=$uid?>"><?=$site_url?>admin/reset_password/index/<?=$uid?></a></p>
