    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-info">
          ...
          <!-- form start -->
<?
if(count($newsletter[0])>0)
{
?>
            <form class="da-home-form form-horizontal" method="post" action="<?php echo base_url(); ?>admin/newsletter/edit_newsletter/<?=$newsletter[0]['news_latter_id']?>">
            <div class="box-body">
              <div class="form-group">
                <label for="subject" class="col-sm-3 control-label"><span class="required">*</span>Subject</label>
                <div class="col-sm-4">
                    <input type="text" required class="form-control"  maxlength="100" name="subject" id="subject" value="<? if(isset($_POST["subject"])){ echo $_POST["subject"]; }else{ echo $newsletter[0]["subject"]; }?>" data-msg-required="Please enter subject.">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                    <textarea required class="form-control" name="description" id="description" rows="3"><? if(isset($_POST["description"])){ echo $_POST["description"];}else{ echo $newsletter[0]["description"]; }?></textarea>
