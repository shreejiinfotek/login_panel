...
<script src="<? echo HTTP_ASSETS_PATH_ADMIN;?>js/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="<? echo HTTP_ASSETS_PATH_ADMIN;?>js/dataTables.bootstrap.js" type="text/javascript"></script>
...
<? if($page=="dash"){ ?>
<script src="<? echo HTTP_ASSETS_PATH_ADMIN;?>js/loader.js" type="text/javascript"></script>
...
var page_name='<?=$page?>';     
    ...
    function drawChart() { 
      var jsonData = $.ajax({ 
          url: "<?=base_url().'admin/dashboard/Our_Sex_Chart'?>", 
          dataType: "json", 
          async: false 
          }).responseText; 
         //alert(jsonData);  
    ...
    function drawCasteChart() { 
      var jsonData = $.ajax({ 
          url: "<?=base_url().'admin/dashboard/Our_Caste_Chart'?>", 
          dataType: "json", 
          async: false 
          }).responseText; 
         //alert(jsonData);  
      // Create our data table out of JSON data loaded from server. 
      var data_caste = new google.visualization.DataTable(jsonData); 
 
      // Instantiate and draw our chart, passing in some options. 
      var castechart = new google.visualization.PieChart(document.getElementById('caste_div')); 
      castechart.draw(data_caste, {height: 400}); 
    } 
