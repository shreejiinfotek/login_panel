  ...
  <div class="inner-wrapper bg_img">
    <div id="login" class="modal">
      ...
      <form class="modal-content animate" action="<?=$action_path?>" name="LoginForm" id="LoginForm" method="post" style="width:50%;" onSubmit="return verify_login()" autocomplete="off">
        <div class="imgcontainer_form"><h1>Login Panel</h1></div>
...
?>
        ...
        <div class="other-btn">
          <div class="back"><b><a href="<?=base_url();?>">Return To Home <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> </a></b> </div>
          <div class="psw"><b> Not A Member ?</b><a href="<?=base_url();?>register"> <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Register Now !</a> </div>
          
          <div class="psw"><b> Forgot Password</b><a href="<?=base_url();?>forgot_password"> <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Click Here !</a> </div>
        </div>
      </form>
    </div>
  </div>
